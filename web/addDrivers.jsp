<%-- 
    Document   : addDrivers
    Created on : Sep 6, 2022, 12:59:44 PM
    Author     : admin
--%>
                    ...
                    <div class="navbar-nav w-100">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu bg-transparent border-0">
                                <a href="addDrivers.jsp" class="dropdown-item active">Driver Registration</a>
            ...
            <div class="content">
                ...
                <div class="container-fluid pt-4 px-4">
                    <div class="bg-light rounded h-100 p-4">
                        <h6 class="mb-4">Add Drivers</h6>
                        <form class="form" method="post" action="CreateDriver">
                            ...
                            <div class="form-floating mb-3">
                                ...
                                <label for="Branch">Associated Branch</label>
                            </div>
