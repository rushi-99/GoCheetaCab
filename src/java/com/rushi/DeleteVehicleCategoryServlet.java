 ...
 * @author admin
 */
@WebServlet("/DeleteVehicleCategoryById")
public class DeleteVehicleCategoryServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        VehicleCategoryBean vehicleCategory = new VehicleCategoryBean();
        ...
        try {
            boolean res = VCategory.deleteCategorybyID(id);
