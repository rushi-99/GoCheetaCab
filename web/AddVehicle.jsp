<%-- 
    Document   : AddVehicle
    Created on : Sep 14, 2022, 10:09:53 AM
    Author     : admin
--%>

<%@page import="com.rushi.bean.VehicleCategoryBean"%>
...
<%
    if (request.getAttribute("categoryList") != null) {
        ...
        response.sendRedirect("categoryListDropDown");
                ...
                <nav class="navbar bg-light navbar-light">
                    ...
                    <div class="navbar-nav w-100">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu bg-transparent border-0">
                                <a href="categoryListDropDown" class="dropdown-item active">Vehicle Registration</a>
            ...
            <div class="content">
                ...
                <div class="container-fluid pt-4 px-4">
                    <div class="bg-light rounded h-100 p-4">
                        ...
                        <form class="form" method="post" action="CreateVehicle">
                            ...
                            <div class="form-floating mb-3">
                                ...
                                <label for="contact">Owner's Contact Number</label>
                            </div>
                            <div class="form-floating mb-3">
                            ...
                            <div class="form-floating mb-3">
                                <select class="form-select" id="VehicleCategory" name="VehicleCategory"
                                        aria-label="Floating label select example" required>
                                    <option selected>select Here</option>

                                    <%
                                        int i = 1;
                                        List<VehicleCategoryBean> category = (List) request.getAttribute("categoryList");
                                    %>
                                    <%
                                        for (VehicleCategoryBean vCategory : category) {

                                    %>
                                    <option value="<%= vCategory.getId()%>"><%= vCategory.getName()%></option>
