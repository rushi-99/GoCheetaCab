<%-- 
    ...
    Created on : Sep 14, 2022, 10:21:54 AM
    Author     : admin
--%>
...
<%
    if (request.getAttribute("ListOfVehicle") == null) {
                    ...
                    <div class="navbar-nav w-100">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu bg-transparent border-0">
                                ...
                                <a href="getDriverDetailsList" class="dropdown-item">Driver's Details</a>
                            </div>
                        </div>

                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown"><i class="fa fa-taxi me-2"></i>Vehicle</a>
                            <div class="dropdown-menu bg-transparent border-0">
                                <a href="categoryListDropDown" class="dropdown-item">Vehicle Registration</a>
                                <a href="GetVehicleList" class="dropdown-item active">Vehicle's Details</a>
                            </div>
                        </div>
                        <div class="nav-item dropdown">
                        ...
                        <div class="table-responsive">
                            <table class="table text-start align-middle table-bordered table-hover mb-0">
                                ...
                                <tbody>
                                    <%
                                        int i = 1;
                                        List<VehicleBean> VehicleDetails = (List) request.getAttribute("ListOfVehicle");
                                    %>
                                    <%
                                        for (VehicleBean ListOfVehicle : VehicleDetails) {


                                    %>
                                    <tr>
                                        <td><%= ListOfVehicle.getVehicleName()%></td>
                                        <td><%= ListOfVehicle.getVehicleNumber()%></td>
                                        <td><%= ListOfVehicle.getCategory()%></td>
                                        <td><%= ListOfVehicle.getOwnerName()%></td>
                                        <td><%= ListOfVehicle.getOwnerContact()%></td>
                                        <td>
                                            <a class="btn btn-sm btn-primary" href="deleteVehicleByID?id=<%=ListOfVehicle.getId()%>">Delete</a>
                                            <a class="btn btn-sm btn-primary" href="getSingleVehicleDetails?id=<%=ListOfVehicle.getId()%>">Edit</a>
                                        </td>
                                    </tr>
                                    <%}%>
                                </tbody>
