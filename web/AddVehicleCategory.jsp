<%-- 
    Document   : AddVehicleCategory
    Created on : Sep 14, 2022, 12:33:48 PM
    Author     : admin
--%>
...
<html>
    ...
    <body>
                ...
                <nav class="navbar bg-light navbar-light">
                    ...
                    <div class="navbar-nav w-100">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu bg-transparent border-0">
                                <a href="AddVehicleCategory.jsp" class="dropdown-item active">Create Vehicle Category</a>
            ...
            <div class="content">
                ...
                <div class="container-fluid pt-4 px-4">
                    <div class="bg-light rounded h-100 p-4">
                        <h6 class="mb-4">Add Vehicle Category</h6>
                        <form class="form" method="post" action="CreateVehicleCategory">
        ...
        <script type="text/javascript">
            ...
            if (status == "success") {
                swal("congrats", "successfully added..", "success");
            }
        </script>
