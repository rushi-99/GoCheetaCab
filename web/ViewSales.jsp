<%-- 
    Document   : ViewSales
    Created on : Sep 19, 2022, 7:30:50 PM
    Author     : admin
--%>
...
<%-- 
    Document   : Admin
    Created on : Sep 5, 2022, 7:35:45 PM
    Author     : admin
--%>
<%
            ...
            <div class="sidebar pe-4 pb-3">
                <nav class="navbar bg-light navbar-light">
                    ...
                    <div class="navbar-nav w-100">
                        ...
                        <a href="ViewSales.jsp" class="nav-item nav-link active"><i class="fa fa-chart-bar me-2"></i>Sales</a>
