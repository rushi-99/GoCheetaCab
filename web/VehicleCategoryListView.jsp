<%-- 
    Document   : VehicleCategoryListView
    Created on : Sep 14, 2022, 12:34:10 PM
    Author     : admin
--%>
...
<%
    if (request.getAttribute("categoryList") == null) {
        response.sendRedirect("getVehicleCategoryList");
            ...
            <div class="sidebar pe-4 pb-3">
                <nav class="navbar bg-light navbar-light">
                    ...
                    <div class="navbar-nav w-100">
                        ...
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown"><i class="fa fa-list me-2"></i>Vehicle Category</a>
                            <div class="dropdown-menu bg-transparent border-0">
                                <a href="AddVehicleCategory.jsp" class="dropdown-item">Create Vehicle Category</a>
                                <a href="getVehicleCategoryList" class="dropdown-item active">View Vehicle Category</a>
                            </div>
                        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table text-start align-middle table-bordered table-hover mb-0">
                                ...
                                <tbody>
                                    <%
                                        int i = 1;
                                        List<VehicleCategoryBean> vehicleDetails = (List) request.getAttribute("categoryList");
                                    %>
                                    <%
                                        for (VehicleCategoryBean vCategory : vehicleDetails) {


                                    %>
                                    <tr>
                                        <td><%= vCategory.getName()%></td>
                                        <td>
                                            <a class="btn btn-sm btn-primary" href="DeleteVehicleCategoryById?id=<%=vCategory.getId()%>">Delete</a>
                                        </td>
                                    </tr>
                                    <%}%>
                                </tbody>
